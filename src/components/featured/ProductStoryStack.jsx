...
const TARS_TRANSITION_PROMPTS = [
  ["Daily Morning", 8, 14, "blue", "sm"],
  ["Evening Report", 23, 9, "slate", "md"],
  ["Daily Career", 48, 11, "orange", "lg"],
  ["Daily Claw", 74, 12, "purple", "md"],
  ["Memory Operator", 91, 18, "blue", "sm"],
  ["Agent Activity", 14, 29, "green", "md"],
  ["Resume Tailor", 34, 24, "slate", "sm"],
  ["Credential Ref", 62, 25, "orange", "md"],
  ["Portfolio Dashboard", 84, 31, "blue", "lg"],
  ["Event Bus", 6, 46, "purple", "md"],
  ["Context Health", 25, 43, "blue", "lg"],
  ["Sprint Closing", 45, 39, "green", "md"],
  ["Open Design", 67, 42, "slate", "sm"],
  ["Browser QA", 92, 47, "orange", "md"],
  ["Approval Queue", 16, 62, "purple", "lg"],
  ["Kanban Move", 38, 58, "blue", "md"],
  ["Ready Executor", 61, 60, "green", "lg"],
  ["Sprint Snapshot", 82, 64, "slate", "md"],
  ["Google Overview", 10, 78, "orange", "sm"],
  ["Google Reauth", 30, 83, "blue", "md"],
  ["Document Delivery", 53, 79, "purple", "md"],
  ["Control Mirror", 73, 84, "green", "sm"],
  ["News Retriever", 89, 77, "purple", "md"],
  ["SeeMe Growth", 19, 18, "orange", "md"],
  ["MoltGuard", 40, 17, "green", "sm"],
  ["SMS Code Helper", 57, 17, "slate", "sm"],
  ["X Search", 79, 22, "purple", "md"],
  ["Scheduler Doctor", 18, 38, "blue", "sm"],
  ["Kanban MCP", 52, 31, "green", "md"],
  ["Web QA Browser", 73, 36, "orange", "sm"],
  ["GitHub Stats", 28, 52, "slate", "md"],
  ["Agent Control", 50, 51, "blue", "xl"],
  ["Automation Scheduler", 72, 53, "purple", "lg"],
  ["Claw Health", 47, 70, "orange", "xl"],
  ["Mac Reset", 68, 72, "blue", "lg"],
  ["LinkedIn Scan", 12, 88, "green", "md"],
  ["Career Draft", 88, 89, "purple", "sm"],
];
