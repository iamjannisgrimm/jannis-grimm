...
const Card = ({ item, index, total }) => {
  ...
  return (
    ...
    >
      ...
      <p style={{ fontSize: isMobile ? "13px" : "15px", fontWeight: 500, color: textColor, margin: "0 0 6px 0", lineHeight: 1.65, flex: isMobile ? "none" : item.secondDescription ? "none" : 1 }}>
        {item.description}
      </p>
      {item.secondDescription && (
        <p style={{ fontSize: isMobile ? "12px" : "13px", color: isDark ? "rgba(255,255,255,0.6)" : "rgba(0,0,0,0.5)", margin: "0 0 0 0", lineHeight: 1.65, flex: isMobile ? "none" : 1 }}>
          {item.secondDescription}
        </p>
      )}
